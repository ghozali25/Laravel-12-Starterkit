...
--
-- Host: localhost    Database: react_stater_kits
-- ------------------------------------------------------
...
CREATE TABLE `asset_categories` (
  ...
  `custom_fields_schema` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `asset_category_brand`
--

DROP TABLE IF EXISTS `asset_category_brand`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `asset_category_brand` (
  `asset_category_id` bigint unsigned NOT NULL,
  `brand_id` bigint unsigned NOT NULL,
  PRIMARY KEY (`asset_category_id`,`brand_id`),
  KEY `asset_category_brand_brand_id_foreign` (`brand_id`)
...
CREATE TABLE `asset_movements` (
  ...
  KEY `asset_movements_from_location_id_foreign` (`from_location_id`),
  KEY `asset_movements_to_location_id_foreign` (`to_location_id`),
  ...
  KEY `asset_movements_status_index` (`status`)
...
CREATE TABLE `assets` (
  ...
  KEY `assets_current_location_id_foreign` (`current_location_id`),
...
--
-- Table structure for table `daily_ticket_status_metrics`
--

DROP TABLE IF EXISTS `daily_ticket_status_metrics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `daily_ticket_status_metrics` (
  `date` date NOT NULL,
  `open` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `loan_items` (
  ...
  `asset_id` bigint unsigned NOT NULL,
  `condition_out` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `condition_in` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `returned_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `loan_items_loan_id_asset_id_unique` (`loan_id`,`asset_id`),
  KEY `loan_items_asset_id_foreign` (`asset_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loans` (
  ...
  `loaned_by_user_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `loans_borrower_user_id_foreign` (`borrower_user_id`),
  KEY `loans_loaned_by_user_id_foreign` (`loaned_by_user_id`),
...
CREATE TABLE `locations` (
  ...
  `type` enum('company','branch','site') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `login_activities` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `login_activities_user_id_event_index` (`user_id`,`event`)
...
CREATE TABLE `settingapp` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nama_app` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `backup_schedule_frequency` enum('off','daily','weekly','monthly') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'off',
  `backup_schedule_time` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '00:30',
  `backup_schedule_weekday` tinyint unsigned DEFAULT NULL,
  `backup_schedule_monthday` tinyint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket_status_histories` (
  ...
  PRIMARY KEY (`id`),
  KEY `ticket_status_histories_ticket_id_changed_at_index` (`ticket_id`,`changed_at`),
  KEY `ticket_status_histories_changed_at_index` (`changed_at`)
...
CREATE TABLE `tickets` (
  ...
  `category` enum('hardware','software','network','email','access','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'other',
  `user_id` bigint unsigned NOT NULL,
...
-- Dump completed on 2025-11-21 11:16:44
